...
public class zadanie_15_laba10 {
    public static void main(String[] args) throws IOException{
        String coordinates = "C:\\Users\\muzbe\\OneDrive\\Рабочий стол\\aboba\\files\\t151.txt";
        String structures = "C:\\Users\\muzbe\\OneDrive\\Рабочий стол\\aboba\\files\\t152.txt";
        String end = "C:\\Users\\muzbe\\OneDrive\\Рабочий стол\\aboba\\files\\t153.txt";
        List<String> d1 = load(coordinates);
        List<String> d2 = load(structures);
        BufferedWriter fwr = new BufferedWriter(new FileWriter(end));
        fwr.write("N участка\tПлощадь участка\tКол-во объектов\t% Площадь дома\t% Площадь бани");
        fwr.newLine();
        for (int i = 0; i < d1.size(); i++) {
            ...
            for (String obj : d2) {
                ...
                if (ground.contains(x, y)) {
                    cnt++;
                    if ("house".equals(type) || "bath".equals(type)) {
